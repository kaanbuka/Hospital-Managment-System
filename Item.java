...
public class Item extends javax.swing.JFrame {
    ...
    public void Item_table() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                v2.add(rs.getString("_description"));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtsellprice, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            st.executeUpdate("INSERT INTO item(itemid,itemname,_description,sellprice, buyprice, qty) VALUES('"+itemno+"', '"+itemname+"', '"+itemdes+"', '"+sellprice+"', '"+buyprice+"', '"+qty+"')");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            st.executeUpdate("update item set itemname = '"+itemname+"', _description = '"+itemdes+"', sellprice = '"+sellprice+"', buyprice = '"+buyprice+"', qty = '"+qty+"' where itemid = '"+itemno+"'");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            st.executeUpdate("DELETE FROM item WHERE itemid = '"+itemno+"'");
